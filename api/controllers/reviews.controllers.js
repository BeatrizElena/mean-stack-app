//  bring in mongoose and models
var mongoose = require('mongoose');
var Hotel = mongoose.model('Hotel');
// create placeholder functions so app doesn't crash
    ...
    Hotel
        ...
        .exec(function(err, hotel) {
            ...
            if (response.status !== 200){
                ...
                hotel.reviews.id(reviewId).remove(); //only code that's different from code in "reviewsUpdateOne" controller
                hotel.save(function(err, hotelUpdated) {
                    if(err){
                        res
                            .status(500)
